...
const Cart = ({roles = []}) => {
    ...
    const changeQuantity = async (cartItem, newQty) => {
        ...
        const updatedItems = cartItems.map((item) =>
            item.id === cartItem.id ? {...item, cartQuantity: newQty} : item
        );
        try {
        ...
        <div className="max-w-6xl mx-auto px-4 py-6 text-base">
            {cartItems.length === 0 ? (
                ...
                <div className="grid lg:grid-cols-3 gap-4">
                            ...
                            >
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-3">
                                        <button
                                            onClick={() => changeQuantity(cartItem, cartItem.cartQuantity - 1)}
                    ...
                    <div className="bg-white shadow rounded-lg p-5 h-fit text-base flex flex-col gap-2">
                ...
                Rs. {cart?.discountAmount?.toLocaleString() || 0}
                        ...
                        <button
                            ...
                            className={`w-full py-2 rounded text-white font-medium transition text-base ${
                        ...
                        <button
                            className="w-full py-2 rounded text-white bg-blue-600 hover:bg-blue-700 font-medium text-base">
                            Checkout
                        </button>

                        <button
                            onClick={clearCart}
                            className="w-full py-2 rounded border border-red-500 text-red-500 hover:bg-red-50 font-medium text-base"
                        >
                            Clear Cart
                        </button>
                    </div>
