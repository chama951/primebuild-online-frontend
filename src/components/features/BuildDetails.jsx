...
const BuildDetails = ({build, onClose}) => {
    ...
    const handleAddItemToCart = async (item, quantity) => {
        try {
            ...
            const updatedItemList = existingItems.map((ci) => ({
                id: ci.item.id,
            ...
            if (index !== -1) {
                ...
                updatedItemList.push({id: item.id, quantity});
            }
            ...
            <div className="bg-white rounded-lg shadow-md max-w-5xl w-full p-6 relative">
                ...
                <p className="text-gray-800 mb-4 font-semibold">
                    ...
                    <span className="text-green-600">
                        LKR {build.totalPrice.toLocaleString()}
                    </span>
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {build.buildItemList.map((bItem, idx) => {
                        ...
                        const features = item.itemFeatureList?.map((f) => ({
                        ...
                        return (
                            <div
                                key={idx}
                                className="border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition flex flex-col bg-white"
                            >
